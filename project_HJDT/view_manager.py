...
class ViewManager:
	...
	def __init__(self):
		...
		# 加载第一种怪物（炸弹）爆炸时的图片
		self.bomb2_imagse = []
		self.bomb2_imagse.append(pygame.image.load("images/bomb2_1.png"))
		self.bomb2_imagse.append(pygame.image.load("images/bomb2_2.png"))
		self.bomb2_imagse.append(pygame.image.load("images/bomb2_3.png"))
		self.bomb2_imagse.append(pygame.image.load("images/bomb2_4.png"))
		self.bomb2_imagse.append(pygame.image.load("images/bomb2_5.png"))
		self.bomb2_imagse.append(pygame.image.load("images/bomb2_6.png"))
		self.bomb2_imagse.append(pygame.image.load("images/bomb2_7.png"))
		self.bomb2_imagse.append(pygame.image.load("images/bomb2_8.png"))
		self.bomb2_imagse.append(pygame.image.load("images/bomb2_9.png"))
		self.bomb2_imagse.append(pygame.image.load("images/bomb2_10.png"))
		self.bomb2_imagse.append(pygame.image.load("images/bomb2_11.png"))
		self.bomb2_imagse.append(pygame.image.load("images/bomb2_12.png"))
		self.bomb2_imagse.append(pygame.image.load("images/bomb2_13.png"))
		# 加载第二种怪物（飞机）的动画帧的图片
		self.fly_images = []
